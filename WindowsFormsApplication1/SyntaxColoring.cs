...
//abstract|array|auto|bool|break|case|catch|char|class|const|const_cast|continue|decltype|default|delegate|delete|do|double|else|enum|struct|event|false|float|for|each |in|friend|goto|if|inline|int|interface |long|namespace|new|return|short|signed|sizeof|static|struct|switch|this|throw|true|try|unsigned|using|virtual|void|while
